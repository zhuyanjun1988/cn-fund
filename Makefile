.PHONY: check-python test verify-evidence verify-c44-public-release verify-c45-public-release verify-c46-public-release policy standard-64-policy c11-policy pdf-guide
...
verify-c44-public-release: check-python
	$(PYTHON) scripts/verify_c44_public_release.py

verify-c45-public-release: check-python
	$(PYTHON) scripts/verify_c45_public_release.py

verify-c46-public-release: check-python
	$(PYTHON) scripts/verify_c46_public_release.py
